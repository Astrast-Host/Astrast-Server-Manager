...
global.gamingPREM = [1]; // Donator Gaming Node Locations.
global.botswebdbPREM = [1]; // Donator Bot, Website, Databases Node Locations.
global.storagePREM = [1]; // Donator Storage Node Locations.
