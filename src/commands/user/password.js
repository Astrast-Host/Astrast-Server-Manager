        ...
        Axios({
            ...
            .then(async (Response) => {
                ...
                client.users.cache
                    ...
                    .send(`New password for Astrast Hosting: ||**${data.password}**||`).catch((Error) => console.log("[PASSWORD RESET] User does not have direct messages enabled."));

                //Formatting the email message.
                const EmailMessage = {
                    from: Config.Email.From,
                    to: data.email,
                    subject: "Astrast Hosting - Password Reset",
                    html:
                ...
                await sendMail(data.email, "Astrast Hosting - Password Reset From Discord Bot", EmailMessage.html).catch((Error) => {            
